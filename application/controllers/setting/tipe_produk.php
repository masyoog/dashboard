 ...
 */
class Tipe_produk extends MY_Controller {

    private $_CFG;
    private $_TBL_PRIMARY = "product_type a";
    private $_TBL_PRIMARY_PK = "a.id";
    private $_ORDER = array("a.type_name ASC");
    ...
    function __construct() {
        ...
        $nama->set_FIELD_DB("a.type_name");
        $nama->set_SIZE(30);
        $nama->set_FORM_ID("name");
        $nama->set_REQUIRED(TRUE);
        $this->_CFG->add_column("Tipe Produk", $nama);
