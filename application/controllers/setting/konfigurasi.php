...
class Konfigurasi extends MY_Controller {
    ...
    private $_CFG;
    private $_TBL_PRIMARY = "sys_config a";
    private $_TBL_PRIMARY_PK = "a.id";
    private $_ORDER = array("a.tipe, a.nama ASC");
    ...
    function __construct() {
        ...
        $menu->set_FIELD_DB("a.tipe");
        $menu->set_SIZE(128);
        $menu->set_FORM_ID("tipe");
        $menu->set_REQUIRED(TRUE);
        $this->_CFG->add_column("Tipe", $menu);
        ...
        $deskripsi = new Datagridcolumn();
        $deskripsi->set_FIELD_DB("a.nilai");
        $deskripsi->set_SIZE(256);
        $deskripsi->set_FORM_ID("nilai");
        $this->_CFG->add_column("nilai", $deskripsi);
