...
class Supplier extends MY_Controller {
    ...
    private $_CFG;
    private $_TBL_PRIMARY = "supplier a";
    private $_TBL_PRIMARY_PK = "a.id";
    private $_ORDER = array("a.supplier_name ASC");
    ...
    function __construct() {
        ...
        $nama->set_FIELD_DB("a.supplier_code");
        $nama->set_SIZE(30);
        ...
        $this->_CFG->add_grid_button(
                "Format Parsing", array(
            "method" => base_url("setting/parsing/index"),
            "style" => "fa-exchange",
