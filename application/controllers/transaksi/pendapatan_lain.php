 ...
 */
class Pendapatan_lain extends MY_Controller {

    private $_CFG;
    private $_TBL_PRIMARY = "income_others a";
    private $_TBL_PRIMARY_PK = "a.income_other_id";
    private $_ORDER = array("a.create_at DESC");
    ...
    function __construct() {
        ...
        $nama->set_REQUIRED(TRUE);
        $this->_CFG->add_column("Jumlah", $nama);
