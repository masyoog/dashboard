    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a target="_blank" href="<?php echo base_url('transaksi/pendapatan_lain') ?>?srcKolom%5B%5D=Tanggal&srcOperan%5B%5D=%3D&srcCari%5B%5D=<?php echo date("d-m-Y") ?>" class="small-box-footer">
                    More info <i class="fa fa-arrow-circle-right"></i>
                </a>
            </div>
        </div> 
                            ...
                            <div class="col-sm-12">
                                <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        <?php 
                                        if ( $rsNewOrder != ""):
                                            foreach ($rsNewOrder as $row):
                                            ?>
                                        <tr role="row" data-id="<?php echo $row->id?>" class="odd">
