        ...
        <div class="form-box" id="login-box">
            ...
            <form method="post" action="<?php echo base_url() ?>authorization/authorized">
                ...
                <div class="body bg-gray">
                    ...
                    <?php } ?>
                    <div class="form-group">
                        <input type="text" name="login" class="form-control" autocomplete="off" placeholder="User ID" maxlength="128"/>
                    </div>
                    <div class="form-group">
                        <input type="password" name="password" class="form-control" autocomplete="off" placeholder="Password" maxlength="128"/>
                    </div>          
                </div>
                <div class="footer">                                                               
