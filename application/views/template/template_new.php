...
<html>
    <head>
        ...
        <link href="<?php echo base_url('assets') ?>/css/datatables/dataTables.tableTools.css" rel="stylesheet" type="text/css" >
    ...
    <body>
                    ...
                    <table id="example" class="table table-bordered table-hover" cellspacing="0" width="100%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th data-type="string">Office</th>
                                <th data-type="number">Age</th>
                                <th data-type="date-range">Start date</th>
                                <th data-type="string">Salary</th>
                            </tr>                            
                        </tfoot>
        ...
        <!--datatables + TableTools-->
        <script src="<?php echo base_url('assets') ?>/js/plugins/datatables/dataTables.tableTools.js" type="text/javascript"></script>
            ...
            $(document).ready(function () {
                ...
                $('#example tfoot th').each(function () {
                    ...
                    if (dataType === "date-range") {
                        //$(this).html('<input type="text" class="elm-date-range" placeholder="Search ' + title + '" />');
                        $(this).html('<div class="input-group input-group-sm" style="width:200px;"><span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control elm-date-range" value=""/></div>');
                    } else {
                ...
                var table = $('#example').DataTable({
                    ...
                    "order": [[1, 'asc']],
                    "dom": '<"row"<"col-sm-6 pull-right"T>>t<"row"<"col-sm-4"i><"col-sm-8"<"row"<"col-sm-3"l><"col-sm-9"p>>>>',
                    "pagingType": "full_numbers",
                    "tableTools": {
                        "sSwfPath": "http://192.168.0.104/tes/others/copy_csv_xls_pdf.swf",
                        "sRowSelect": "os",
...
//                        "aButtons": [ "copy", "csv", "xls","pdf","print","select_all", "select_none" ]
                ...
                $('.elm-date-range').daterangepicker({format: "DD/MM/YYYY"});
            });
        </script>
    </body>
</html>
