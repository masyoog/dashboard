...
//                echo $row->uri ." = ". str_replace(base_url(), "", site_url($this->CI->router->fetch_directory() . $this->CI->router->fetch_class()));
                $active_menu = $row->uri == str_replace(base_url(), "", site_url($this->CI->router->fetch_directory() . $this->CI->router->fetch_class()));
