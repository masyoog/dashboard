...
class Datagridcolumn {
    ...
    public function get_TRUNCATABLE(){
        return $this->_TRUNCATABLE;
    }
    
    public function set_ESCAPESPECIALCHAR($_ESCAPESPECIALCHAR){
        $this->_ESCAPESPECIALCHAR = $_ESCAPESPECIALCHAR;
    }
    
    public function get_ESCAPESPECIALCHAR(){
        return $this->_ESCAPESPECIALCHAR;
    }
    
    public function set_TIMESTAMP_TYPE($_TIMESTAMP_TYPE){
        $this->_TIMESTAMP_TYPE = $_TIMESTAMP_TYPE;
    }
    
    public function get_TIMESTAMP_TYPE(){
        return $this->_TIMESTAMP_TYPE;
    }
    ...
    public function get_DOUBLE_TYPE() {
        return $this->_DOUBLE_TYPE;
    }
    
    public function set_DOBLE_TYPE($_DOUBLE_TYPE) {
        $this->_DOUBLE_TYPE = $_DOUBLE_TYPE;
    }
